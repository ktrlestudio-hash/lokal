        ...
        <div className="max-w-[1400px] mx-auto px-4 lg:px-8 h-[72px] flex items-center gap-3">
          ...
          <div className="flex-1 relative">
            <div className="h-[44px] rounded-full border border-white/[0.08] bg-white/[0.05] backdrop-blur-xl flex items-center px-4 shadow-xl shadow-black/20">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.6} stroke="currentColor" className="w-5 h-5 text-white/45">
                <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-4.35-4.35m1.85-5.15a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z" />
              </svg>
              <div className="ml-3 text-[14px] text-white/35 font-medium">Search products...</div>
            </div>
          </div>
          ...
          <button className="relative w-11 h-11 rounded-2xl border border-white/[0.08] bg-white/[0.05] backdrop-blur-xl flex items-center justify-center shadow-xl shadow-black/20 hover:scale-[1.03] transition-all duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.7} stroke="currentColor" className="w-5 h-5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386a.75.75 0 0 1 .728.568l.651 2.606m0 0 1.5 6A.75.75 0 0 0 7.242 15h9.516a.75.75 0 0 0 .728-.568l1.742-6.968a.75.75 0 0 0-.728-.932H5.015m0 0L4.5 4.5M7.5 18.75a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm12 0a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" />
            </svg>
          ...
          <section className="relative overflow-hidden rounded-[34px] h-[440px] lg:h-[560px] border border-white/[0.05] shadow-[0_40px_120px_rgba(0,0,0,.65)]">
            ...
            <div className="relative z-10 h-full flex flex-col justify-end p-6 lg:p-12">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.08] border border-white/[0.12] backdrop-blur-xl w-fit mb-5">
                ...
                <span className="text-[11px] uppercase tracking-[0.22em] text-white/70 font-bold">Featured Collection</span>
              </div>

              <div className="max-w-[620px]">
                <h1 className="text-[44px] lg:text-[76px] leading-[0.9] font-black tracking-[-0.06em]">
                  PREMIUM<br />DARK STORE
                </h1>
                <p className="mt-5 text-[15px] lg:text-[17px] leading-relaxed text-white/70 max-w-[520px]">
                  Placeholder description for a premium modern storefront experience with cinematic visuals and immersive UI.
                </p>
          ...
          <div className="mt-8 lg:grid lg:grid-cols-[280px_1fr] gap-8 items-start">
            <aside className="hidden lg:block sticky top-[100px]">
              <div className="rounded-[28px] border border-white/[0.05] bg-[#0b0f18]/95 backdrop-blur-2xl p-5 shadow-[0_20px_60px_rgba(0,0,0,.45)]">
                <div className="flex items-center justify-between mb-5">
                  <h2 className="text-[14px] uppercase tracking-[0.18em] text-white/45 font-black">Categories</h2>
                ...
                <div className="space-y-2">
                  {categories.map((cat, i) => (
                    <button key={cat} className={`w-full h-[52px] rounded-2xl px-4 flex items-center justify-between transition-all duration-300 border ${
                      i === 0
                      ...
                      <span className="font-semibold tracking-[-0.02em]">{cat}</span>
            ...
            <section>
              <div className="flex items-center justify-between mb-5 px-1">
                <div>
                  <h2 className="text-[26px] lg:text-[34px] font-black tracking-[-0.05em] leading-none">Trending Products</h2>
                  <p className="mt-2 text-white/45 text-[14px]">Curated premium selection placeholder.</p>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[14px] lg:gap-[18px]">
                {products.map((product) => (
                  <div key={product.id} className="group relative rounded-[28px] overflow-hidden border border-white/[0.04] bg-[#0b0f18] shadow-[0_20px_50px_rgba(0,0,0,.55)] hover:-translate-y-1 hover:shadow-[0_28px_70px_rgba(0,0,0,.7)] transition-all duration-500">
                    <div className="relative aspect-[1/1.38] overflow-hidden">
                      <img src={product.image} className="absolute inset-0 w-full h-full object-cover brightness-[.96] contrast-110 saturate-110 group-hover:scale-[1.05] transition-all duration-700" />
                      ...
                      <button className="absolute top-3 right-3 w-9 h-9 rounded-full border border-white/[0.12] bg-black/35 backdrop-blur-xl flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-4 h-4">
                          <path strokeLinecap="round" strokeLinejoin="round" d="m21 8.25-8.25 8.25-4.5-4.5" />
                        </svg>
                      </button>

                      <div className="absolute bottom-0 left-0 right-0 p-4 lg:p-5">
                        <div className="text-[11px] uppercase tracking-[0.18em] text-white/45 font-bold mb-2">{product.category}</div>
                        <h3 className="text-[17px] lg:text-[18px] font-black tracking-[-0.04em] leading-tight">{product.title}</h3>
                        <div className="mt-3 flex items-end justify-between gap-3">
                          <div>
                            <div className="text-white/35 line-through text-[13px] font-medium">{product.oldPrice}</div>
                            <div className="text-[18px] lg:text-[20px] font-black tracking-[-0.04em]">{product.price}</div>
                          </div>
      ...
      <div className="lg:hidden fixed bottom-3 left-3 right-3 z-50 rounded-[26px] border border-white/[0.06] bg-[#0a0f1bcc] backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,.45)] px-2 py-2">
        <div className="grid grid-cols-4 gap-2">
          {['Home', 'Search', 'Saved', 'Cart'].map((item, i) => (
            <button key={item} className={`h-[58px] rounded-2xl flex flex-col items-center justify-center text-[11px] font-semibold transition-all duration-300 ${
              i === 0
